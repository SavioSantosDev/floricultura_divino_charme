...
export class CustomValidation {
  ...
  private static latitudeRegExp = /^(\+|-)?(?:90(?:(?:\.0{1,14})?)|(?:[0-9]|[1-8][0-9])(?:(?:\.[0-9]{1,14})?))$/;
  private static longitudeRegExp = /^(\+|-)?(?:180(?:(?:\.0{1,14})?)|(?:[0-9]|[1-9][0-9]|1[0-7][0-9])(?:(?:\.[0-9]{1,14})?))$/;
  private static numbersRegExp = /^-?\d+$/;
  private static phoneRegExp = /^\(?[1-9]{2}\)?\s?(?:[2-8]|9[1-9])[0-9]{3}\-?\s?[0-9]{4}$/;
